...
func (con *FocusController) Index(c *gin.Context) {
	c.HTML(http.StatusOK, "templates/focus/index.html", gin.H{})
}

func (con *FocusController) Add(c *gin.Context) {
	c.HTML(http.StatusOK, "templates/focus/add.html", gin.H{})
}

func (con *FocusController) Edit(c *gin.Context) {
	c.HTML(http.StatusOK, "templates/focus/edit.html", gin.H{})
}
